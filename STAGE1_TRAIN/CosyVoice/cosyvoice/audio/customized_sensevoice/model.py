...
class SenseVoiceEncoderSmall(nn.Module):
    ...
    def forward(
        ...
        xs_pad: torch.Tensor,
        ilens: torch.Tensor,
        extract_hidden: Optional[bool] = False,
    ):
        ...
        if extract_hidden:
            hidden_xs_pad = xs_pad # hidden output before tp_encoder
        ...
        if extract_hidden:
            return xs_pad, olens, hidden_xs_pad
...
class SenseVoiceSmall(nn.Module):
    ...
    def forward(
        ...
        **kwargs,
        ...
        # 1. Encoder
        encoder_out, encoder_out_lens, hidden_out = self.encode(speech, speech_lengths, text)
    ...
    def encode(
        ...
        **kwargs,
        ...
        encoder_out, encoder_out_lens, hidden_out = self.encoder(speech, speech_lengths, extract_hidden)

        return encoder_out, encoder_out_lens, hidden_out
    ...
    def prepare_inputs(
        ...
        **kwargs,
        ...
        if (
            ...
            # print(speech.shape, speech_lengths.shape)
            # print(speech[0][:1][:20], speech_lengths)
        ...
        speech, speech_lengths = self.prepend_inputs(speech, speech_lengths, **kwargs)
        
        return meta_data, speech, speech_lengths
    ...
    def inference(
        ...
        **kwargs,
        ...
        for i in range(b):
            ...
            result_i = {
                "speech": speech[i],
                "speech_length": speech_length[i],
                "key": key[i], 
                "text": text, 
                "raw": raw_yseq, 
                "encoder_out": encoder_out[i, : encoder_out_lens[i].item(), :]
            }
